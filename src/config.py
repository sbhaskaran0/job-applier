...
# Per-job tailored artifacts (JOB-6): resumes/<job-slug>/{resume.docx,resume.pdf,
# cover_letter.txt,cover_letter.pdf}. Gitignored — personal, per-application.
